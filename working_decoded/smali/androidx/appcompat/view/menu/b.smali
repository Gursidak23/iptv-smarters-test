...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->m:Lk/S;
...
.method public final E(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-static {v1, v5, v2, v4}, Lj/d;->m(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v2

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/b;->y()Lk/T;

    move-result-object v4

    invoke-virtual {v4, v1}, Lk/Q;->m(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Lk/Q;->E(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->o:I

    invoke-virtual {v4, v1}, Lk/Q;->F(I)V
    ...
    invoke-virtual {v4, v7}, Lk/T;->T(Z)V

    invoke-virtual {v4, v5}, Lk/T;->Q(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Lk/Q;->C(Landroid/view/View;)V
    ...
    :goto_5
    invoke-virtual {v4, v12}, Lk/Q;->e(I)V

    invoke-virtual {v4, v3}, Lk/Q;->L(Z)V

    invoke-virtual {v4, v8}, Lk/Q;->i(I)V
    ...
    invoke-virtual {v4, v2}, Lk/Q;->i(I)V

    :cond_b
    invoke-virtual {p0}, Lj/d;->l()Landroid/graphics/Rect;

    move-result-object v2

    invoke-virtual {v4, v2}, Lk/Q;->G(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Lk/T;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->j:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Lk/Q;->show()V

    invoke-virtual {v4}, Lk/Q;->o()Landroid/widget/ListView;
...
.method public a()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Lk/T;

    invoke-virtual {v0}, Lk/Q;->a()Z
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Lk/T;

    invoke-virtual {v1, v2}, Lk/T;->R(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Lk/T;

    invoke-virtual {v1, v3}, Lk/Q;->D(I)V
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Lk/T;

    invoke-virtual {v3}, Lk/Q;->a()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Lk/T;

    invoke-virtual {v2}, Lk/Q;->dismiss()V
...
.method public f(Z)V
    ...
    invoke-static {v0}, Lj/d;->x(Landroid/widget/ListAdapter;)Landroidx/appcompat/view/menu/d;
...
.method public n(Landroid/view/View;)V
    ...
    invoke-static {v0, p1}, LP/p;->b(II)I
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Lk/T;

    invoke-virtual {v4}, Lk/Q;->a()Z
...
.method public final y()Lk/T;
    ...
    .line 10
    invoke-direct {v0, v1, v4, v2, v3}, Lk/T;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    .line 11
    .line 12
    .line 13
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->m:Lk/S;

    .line 14
    .line 15
    invoke-virtual {v0, v1}, Lk/T;->S(Lk/S;)V

    .line 16
    .line 17
    .line 18
    invoke-virtual {v0, p0}, Lk/Q;->K(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 19
    .line 20
    .line 21
    invoke-virtual {v0, p0}, Lk/Q;->J(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    .line 25
    .line 26
    invoke-virtual {v0, v1}, Lk/Q;->C(Landroid/view/View;)V
    ...
    .line 30
    .line 31
    invoke-virtual {v0, v1}, Lk/Q;->F(I)V
    ...
    .line 35
    invoke-virtual {v0, v1}, Lk/Q;->I(Z)V
    ...
    .line 39
    invoke-virtual {v0, v1}, Lk/Q;->H(I)V
