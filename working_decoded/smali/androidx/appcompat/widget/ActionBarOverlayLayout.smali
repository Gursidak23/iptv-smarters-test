...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, LP/X;->b:LP/X;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LP/X;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LP/X;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LP/X;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:LP/X;
    ...
    invoke-direct {p1, p0}, LP/D;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:LP/D;
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Lk/H;

    invoke-interface {v0}, Lk/H;->a()Z
...
.method public d(Landroid/view/Menu;Landroidx/appcompat/view/menu/i$a;)V
    ...
    invoke-interface {v0, p1, p2}, Lk/H;->d(Landroid/view/Menu;Landroidx/appcompat/view/menu/i$a;)V
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:LP/D;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lk/H;->getTitle()Ljava/lang/CharSequence;
...
.method public h(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Lk/H;

    invoke-interface {p1}, Lk/H;->y()V
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1, p0}, LP/X;->v(Landroid/view/WindowInsets;Landroid/view/View;)LP/X;
    ...
    invoke-static {p0, p1, v1}, LP/L;->h(Landroid/view/View;LP/X;Landroid/graphics/Rect;)LP/X;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, LP/X;->l(IIII)LP/X;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LP/X;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LP/X;

    invoke-virtual {v2, v1}, LP/X;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LP/X;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LP/X;
    ...
    :cond_2
    invoke-virtual {p1}, LP/X;->a()LP/X;

    move-result-object p1

    invoke-virtual {p1}, LP/X;->c()LP/X;

    move-result-object p1

    invoke-virtual {p1}, LP/X;->b()LP/X;
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, LP/L;->O(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LP/X;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LP/X;
    ...
    invoke-virtual {v6, v2, v5, v2, v2}, LP/X;->l(IIII)LP/X;

    move-result-object v2

    :goto_2
    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LP/X;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LP/X;

    invoke-virtual {v4}, LP/X;->k()I

    move-result v4

    add-int/2addr v4, v5

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LP/X;

    invoke-virtual {v5}, LP/X;->j()I

    move-result v5

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LP/X;

    invoke-virtual {v6}, LP/X;->h()I

    move-result v6

    invoke-static {v2, v4, v5, v6}, LG/b;->b(IIII)LG/b;
    ...
    invoke-direct {v4, v5}, LP/X$b;-><init>(LP/X;)V

    invoke-virtual {v4, v2}, LP/X$b;->c(LG/b;)LP/X$b;

    move-result-object v2

    invoke-virtual {v2}, LP/X$b;->a()LP/X;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:LP/X;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LP/X;

    invoke-virtual {v2, v4}, LP/X;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LP/X;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:LP/X;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->d:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, LP/L;->i(Landroid/view/View;LP/X;)LP/X;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, LP/D;->b(Landroid/view/View;Landroid/view/View;I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Lk/H;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Lk/H;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Lk/H;->t(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Lk/H;->setWindowCallback(Landroid/view/Window$Callback;)V
...
.method public final t(Landroid/view/View;)Lk/H;
    .locals 3
...
.method public z()V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t(Landroid/view/View;)Lk/H;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Lk/H;
