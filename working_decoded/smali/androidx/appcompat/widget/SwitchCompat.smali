...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v3}, Lk/Z;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    sget-object v3, Lc/j;->L2:[I

    invoke-static {p1, p2, v3, p3, v1}, Lk/d0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lk/d0;

    move-result-object v3

    sget-object v6, Lc/j;->L2:[I

    invoke-virtual {v3}, Lk/d0;->r()Landroid/content/res/TypedArray;
    ...
    invoke-static/range {v4 .. v10}, LP/L;->q0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    sget v4, Lc/j;->O2:I

    invoke-virtual {v3, v4}, Lk/d0;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v3, v4}, Lk/d0;->p(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3, v4, v2}, Lk/d0;->a(IZ)Z
    ...
    invoke-virtual {v3, v4, v1}, Lk/d0;->f(II)I
    ...
    invoke-virtual {v3, v4, v1}, Lk/d0;->a(IZ)Z
    ...
    invoke-virtual {v3, v4}, Lk/d0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v3, v4, v5}, Lk/d0;->k(II)I

    move-result v4

    invoke-static {v4, v0}, Lk/M;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v3, v0, v1}, Lk/d0;->n(II)I
    ...
    invoke-direct {v0, p0}, Lk/A;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Lk/A;

    invoke-virtual {v0, p2, p3}, Lk/A;->m(Landroid/util/AttributeSet;I)V

    invoke-virtual {v3}, Lk/d0;->w()V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lk/l;
...
.method private getEmojiTextViewHelper()Lk/l;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->Q:Lk/l;
    ...
    .line 9
    .line 10
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->Q:Lk/l;
...
.method private getThumbOffset()I
    ...
    invoke-static {p0}, Lk/m0;->b(Landroid/view/View;)Z
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Lk/M;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lk/M;->c:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Lk/M;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Lk/M;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v2, v5, v4}, LH/a;->l(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final g(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, Lk/l;->f(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final k()V
    ...
    :cond_0
    invoke-static {p0, v0}, LP/L;->J0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public m(Landroid/content/Context;I)V
    ...
    invoke-virtual {p1, p2}, Lk/d0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2, v0}, Lk/d0;->f(II)I
    ...
    invoke-virtual {p1, p2, v1}, Lk/d0;->k(II)I

    move-result p2

    sget v2, Lc/j;->d3:I

    invoke-virtual {p1, v2, v1}, Lk/d0;->k(II)I
    ...
    invoke-virtual {p1, p2, v0}, Lk/d0;->a(IZ)Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lk/M;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Lk/M;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
