...
.method public run()V
    ...
    iget-object v4, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->awsConfiguration:Lcom/amazonaws/mobile/config/AWSConfiguration;

    if-eqz v4, :cond_0

    iget-object v0, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->val$callback:Lcom/amazonaws/mobile/client/Callback;

    invoke-virtual {v3, v1}, Lcom/amazonaws/mobile/client/AWSMobileClient;->getUserStateDetails(Z)Lcom/amazonaws/mobile/client/UserStateDetails;
    ...
    :cond_0
    iput-boolean v1, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->mIsPersistenceEnabled:Z
    :try_end_0
    ...
    invoke-virtual {v3, v4}, Lcom/amazonaws/mobile/config/AWSConfiguration;->optJsonObject(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-virtual {v4, v5}, Lcom/amazonaws/mobile/config/AWSConfiguration;->optJsonObject(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-virtual {v4}, Lcom/amazonaws/mobile/config/AWSConfiguration;->getUserAgentOverride()Ljava/lang/String;

    move-result-object v4

    iput-object v4, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->userAgentOverride:Ljava/lang/String;
    ...
    iput-object v4, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->this$0:Lcom/amazonaws/mobile/client/AWSMobileClient;

    new-instance v4, Lcom/amazonaws/mobile/client/AWSMobileClientStore;

    invoke-direct {v4, v3}, Lcom/amazonaws/mobile/client/AWSMobileClientStore;-><init>(Lcom/amazonaws/mobile/client/AWSMobileClient;)V

    iput-object v4, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->mStore:Lcom/amazonaws/mobile/client/KeyValueStore;
    ...
    iget-object v4, v4, Lcom/amazonaws/mobile/client/AWSMobileClient;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Lcom/amazonaws/mobile/auth/core/IdentityManager;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v0}, Lcom/amazonaws/mobile/auth/core/IdentityManager;->enableFederation(Z)V

    iget-object v4, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->val$awsConfiguration:Lcom/amazonaws/mobile/config/AWSConfiguration;

    invoke-virtual {v3, v4}, Lcom/amazonaws/mobile/auth/core/IdentityManager;->setConfiguration(Lcom/amazonaws/mobile/config/AWSConfiguration;)V

    iget-object v4, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->this$0:Lcom/amazonaws/mobile/client/AWSMobileClient;

    iget-boolean v4, v4, Lcom/amazonaws/mobile/client/AWSMobileClient;->mIsPersistenceEnabled:Z

    invoke-virtual {v3, v4}, Lcom/amazonaws/mobile/auth/core/IdentityManager;->setPersistenceEnabled(Z)V
    ...
    invoke-direct {v4, p0, v3}, Lcom/amazonaws/mobile/client/AWSMobileClient$2$1;-><init>(Lcom/amazonaws/mobile/client/AWSMobileClient$2;Lcom/amazonaws/mobile/auth/core/IdentityManager;)V

    invoke-virtual {v3, v4}, Lcom/amazonaws/mobile/auth/core/IdentityManager;->addSignInStateChangeListener(Lcom/amazonaws/mobile/auth/core/SignInStateChangeListener;)V
    ...
    invoke-direct {v5, v7, v6, v3}, Lcom/amazonaws/auth/CognitoCachingCredentialsProvider;-><init>(Landroid/content/Context;Lcom/amazonaws/auth/AWSCognitoIdentityProvider;Lcom/amazonaws/regions/Regions;)V
    ...
    iget-object v4, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->cognitoIdentity:Lcom/amazonaws/auth/CognitoCachingCredentialsProvider;

    iget-boolean v3, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->mIsPersistenceEnabled:Z

    invoke-virtual {v4, v3}, Lcom/amazonaws/auth/CognitoCachingCredentialsProvider;->setPersistenceEnabled(Z)V

    iget-object v3, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->this$0:Lcom/amazonaws/mobile/client/AWSMobileClient;

    iget-object v4, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->userAgentOverride:Ljava/lang/String;

    if-eqz v4, :cond_3

    iget-object v3, v3, Lcom/amazonaws/mobile/client/AWSMobileClient;->cognitoIdentity:Lcom/amazonaws/auth/CognitoCachingCredentialsProvider;

    invoke-virtual {v3, v4}, Lcom/amazonaws/auth/CognitoCachingCredentialsProvider;->setUserAgentOverride(Ljava/lang/String;)V
    :try_end_3
    ...
    iput-object v0, v4, Lcom/amazonaws/mobile/client/AWSMobileClient;->userpoolsLoginKey:Ljava/lang/String;

    iget-object v0, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->this$0:Lcom/amazonaws/mobile/client/AWSMobileClient;

    new-instance v3, Lcom/amazonaws/mobileconnectors/cognitoidentityprovider/CognitoUserPool;
    ...
    iput-object v3, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->userpool:Lcom/amazonaws/mobileconnectors/cognitoidentityprovider/CognitoUserPool;

    iget-object v0, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->this$0:Lcom/amazonaws/mobile/client/AWSMobileClient;

    iget-object v3, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->userpool:Lcom/amazonaws/mobileconnectors/cognitoidentityprovider/CognitoUserPool;

    iget-boolean v0, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->mIsPersistenceEnabled:Z

    invoke-virtual {v3, v0}, Lcom/amazonaws/mobileconnectors/cognitoidentityprovider/CognitoUserPool;->setPersistenceEnabled(Z)V

    iget-object v0, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->this$0:Lcom/amazonaws/mobile/client/AWSMobileClient;

    new-instance v3, Lcom/amazonaws/mobile/client/DeviceOperations;

    iget-object v4, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->userpoolLL:Lcom/amazonaws/services/cognitoidentityprovider/AmazonCognitoIdentityProvider;

    invoke-direct {v3, v0, v4}, Lcom/amazonaws/mobile/client/DeviceOperations;-><init>(Lcom/amazonaws/mobile/client/AWSMobileClient;Lcom/amazonaws/services/cognitoidentityprovider/AmazonCognitoIdentityProvider;)V

    iput-object v3, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->mDeviceOperations:Lcom/amazonaws/mobile/client/DeviceOperations;
    :try_end_5
    ...
    invoke-virtual {v0, v3}, Lcom/amazonaws/mobile/client/AWSMobileClient;->getHostedUIJSON(Lcom/amazonaws/mobile/config/AWSConfiguration;)Lorg/json/JSONObject;
    ...
    invoke-direct {v3, v5, v4}, Lcom/amazonaws/mobile/client/internal/oauth2/OAuth2Client;-><init>(Landroid/content/Context;Lcom/amazonaws/mobile/client/AWSMobileClient;)V

    iput-object v3, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->mOAuth2Client:Lcom/amazonaws/mobile/client/internal/oauth2/OAuth2Client;

    iget-object v0, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->this$0:Lcom/amazonaws/mobile/client/AWSMobileClient;

    iget-object v3, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->mOAuth2Client:Lcom/amazonaws/mobile/client/internal/oauth2/OAuth2Client;

    iget-boolean v0, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->mIsPersistenceEnabled:Z

    invoke-virtual {v3, v0}, Lcom/amazonaws/mobile/client/internal/oauth2/OAuth2Client;->setPersistenceEnabled(Z)V
    ...
    invoke-virtual {v3, v0}, Lcom/amazonaws/mobile/client/internal/oauth2/OAuth2Client;->setUserAgentOverride(Ljava/lang/String;)V
    ...
    invoke-static {v3, v0}, Lcom/amazonaws/mobile/client/AWSMobileClient;->access$500(Lcom/amazonaws/mobile/client/AWSMobileClient;Lorg/json/JSONObject;)V
    :try_end_7
    ...
    :goto_7
    :try_start_8
    iget-object v3, p0, Lcom/amazonaws/mobile/client/AWSMobileClient$2;->val$callback:Lcom/amazonaws/mobile/client/Callback;
    ...
    iget-object v3, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->cognitoIdentity:Lcom/amazonaws/auth/CognitoCachingCredentialsProvider;
    ...
    iput-object v3, v0, Lcom/amazonaws/mobile/client/AWSMobileClient;->awsConfiguration:Lcom/amazonaws/mobile/config/AWSConfiguration;
