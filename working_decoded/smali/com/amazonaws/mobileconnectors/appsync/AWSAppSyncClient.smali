...
# static fields
.field static final CLIENT_DATABAE_PREFIX_PATTERN:Ljava/lang/String; = "^[_a-zA-Z0-9]+$"

.field static final DATABASE_NAME_DELIMITER:Ljava/lang/String; = "_"

.field static final DEFAULT_DELTA_SYNC_SQL_STORE_NAME:Ljava/lang/String; = "appsync_deltasync_db"

.field static final DEFAULT_MUTATION_SQL_STORE_NAME:Ljava/lang/String; = "appsyncstore_mutation"

.field static final DEFAULT_QUERY_SQL_STORE_NAME:Ljava/lang/String; = "appsyncstore"

.field private static final TAG:Ljava/lang/String;

.field static prefixMap:Ljava/util/Map;
...
.field clientDatabasePrefix:Ljava/lang/String;

.field deltaSyncSqlStoreName:Ljava/lang/String;

.field mApolloClient:Lu1/a;
...
.field mSyncStore:Lcom/amazonaws/mobileconnectors/appsync/cache/normalized/AppSyncStore;

.field mutationSqlStoreName:Ljava/lang/String;
...
.field querySqlStoreName:Ljava/lang/String;
...
.method private constructor <init>(Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;)V
    ...
    iget-object v0, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mNormalizedCacheFactory:Lz1/g;
    ...
    invoke-direct {v1, v0}, LA1/b;-><init>(Lcom/amazonaws/mobileconnectors/appsync/cache/normalized/sql/AppSyncSqlHelper;)V

    iput-object v1, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mNormalizedCacheFactory:Lz1/g;
    ...
    invoke-direct {v4, v1}, LK1/d;-><init>(Ljava/util/Map;)V
    ...
    iget-object v6, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mS3ObjectManager:Lv1/r;

    move-object v1, v0

    move-object v3, v11

    invoke-direct/range {v1 .. v6}, Lcom/amazonaws/mobileconnectors/appsync/AppSyncCustomNetworkInvoker;-><init>(Lokhttp3/HttpUrl;Lokhttp3/Call$Factory;LK1/d;Lcom/amazonaws/mobileconnectors/appsync/PersistentMutationsCallback;Lv1/r;)V
    ...
    invoke-static {}, Lu1/a;->b()Lu1/a$b;

    move-result-object v0

    iget-object v1, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mServerUrl:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lu1/a$b;->k(Ljava/lang/String;)Lu1/a$b;

    move-result-object v0

    iget-object v1, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mNormalizedCacheFactory:Lz1/g;

    iget-object v2, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mResolver:Lz1/c;

    invoke-virtual {v0, v1, v2}, Lu1/a$b;->i(Lz1/g;Lz1/c;)Lu1/a$b;

    move-result-object v0

    invoke-virtual {v0, v12}, Lu1/a$b;->a(LD1/a;)Lu1/a$b;
    ...
    invoke-virtual {v13, v14}, Lu1/a$b;->a(LD1/a;)Lu1/a$b;

    move-result-object v0

    new-instance v1, Lcom/amazonaws/mobileconnectors/appsync/AppSyncComplexObjectsInterceptor;

    iget-object v2, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mS3ObjectManager:Lv1/r;

    invoke-direct {v1, v2}, Lcom/amazonaws/mobileconnectors/appsync/AppSyncComplexObjectsInterceptor;-><init>(Lv1/r;)V

    invoke-virtual {v0, v1}, Lu1/a$b;->a(LD1/a;)Lu1/a$b;

    move-result-object v0

    invoke-virtual {v0, v11}, Lu1/a$b;->j(Lokhttp3/OkHttpClient;)Lu1/a$b;
    ...
    invoke-virtual {v0, v2, v3}, Lu1/a$b;->b(Lv1/s;Lu1/b;)Lu1/a$b;
    ...
    invoke-virtual {v0, v1}, Lu1/a$b;->h(Ljava/util/concurrent/Executor;)Lu1/a$b;

    :cond_8
    iget-object v1, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mCacheHeaders:Ly1/a;

    if-eqz v1, :cond_9

    invoke-virtual {v0, v1}, Lu1/a$b;->e(Ly1/a;)Lu1/a$b;

    :cond_9
    iget-object v1, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mDefaultResponseFetcher:LC1/a;

    if-eqz v1, :cond_a

    invoke-virtual {v0, v1}, Lu1/a$b;->g(LC1/a;)Lu1/a$b;
    ...
    invoke-virtual {v0, v1}, Lu1/a$b;->l(LL1/b;)Lu1/a$b;

    invoke-virtual {v0}, Lu1/a$b;->c()Lu1/a;

    move-result-object v0

    iput-object v0, v9, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mApolloClient:Lu1/a;

    invoke-virtual {v1, v0}, Lcom/amazonaws/mobileconnectors/appsync/subscription/RealSubscriptionManager;->setApolloClient(Lu1/a;)V

    new-instance v0, Lcom/amazonaws/mobileconnectors/appsync/cache/normalized/AppSyncStore;

    iget-object v2, v9, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mApolloClient:Lu1/a;

    invoke-virtual {v2}, Lu1/a;->a()Lz1/a;

    move-result-object v2

    invoke-direct {v0, v2}, Lcom/amazonaws/mobileconnectors/appsync/cache/normalized/AppSyncStore;-><init>(Lz1/a;)V
    ...
    iget-object v0, v9, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mApolloClient:Lu1/a;

    invoke-virtual {v0}, Lu1/a;->a()Lz1/a;

    move-result-object v0

    invoke-virtual {v12, v0}, Lcom/amazonaws/mobileconnectors/appsync/AppSyncOptimisticUpdateInterceptor;->setStore(Lz1/a;)V
    ...
    invoke-virtual {v1, v0}, Lcom/amazonaws/mobileconnectors/appsync/subscription/RealSubscriptionManager;->setStore(Lz1/a;)V
    ...
    invoke-direct {v0, v2}, LK1/d;-><init>(Ljava/util/Map;)V

    invoke-virtual {v1, v0}, Lcom/amazonaws/mobileconnectors/appsync/subscription/RealSubscriptionManager;->setScalarTypeAdapters(LK1/d;)V

    iget-object v0, v10, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient$Builder;->mS3ObjectManager:Lv1/r;

    iput-object v0, v9, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mS3ObjectManager:Lv1/r;
    ...
    iget-object v6, v9, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mApolloClient:Lu1/a;

    invoke-virtual {v6}, Lu1/a;->a()Lz1/a;

    move-result-object v6

    invoke-interface {v6}, Lz1/a;->j()LF1/h;

    move-result-object v6

    invoke-direct {v5, v1, v6}, Lcom/amazonaws/mobileconnectors/appsync/ApolloResponseBuilder;-><init>(Ljava/util/Map;LF1/h;)V
...
.method public clearCaches(Lcom/amazonaws/mobileconnectors/appsync/ClearCacheOptions;)V
    ...
    invoke-virtual {v1}, Lcom/amazonaws/mobileconnectors/appsync/cache/normalized/AppSyncStore;->clearAll()Lz1/e;

    move-result-object v1

    invoke-virtual {v1}, Lz1/e;->c()Ljava/lang/Object;
    :try_end_0
...
.method public getS3ObjectManager()Lv1/r;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mS3ObjectManager:Lv1/r;
...
.method public mutate(Lv1/e;)Lcom/amazonaws/mobileconnectors/appsync/AppSyncMutationCall;
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mutate(Lv1/e;Z)Lcom/amazonaws/mobileconnectors/appsync/AppSyncMutationCall;
...
.method public mutate(Lv1/e;Lv1/f$a;)Lcom/amazonaws/mobileconnectors/appsync/AppSyncMutationCall;
    ...
    .line 2
    invoke-virtual {p0, p1, p2, v0}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mutate(Lv1/e;Lv1/f$a;Z)Lcom/amazonaws/mobileconnectors/appsync/AppSyncMutationCall;
...
.method public mutate(Lv1/e;Lv1/f$a;Z)Lcom/amazonaws/mobileconnectors/appsync/AppSyncMutationCall;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
    ...
    :cond_0
    iget-object p3, p0, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mApolloClient:Lu1/a;

    invoke-virtual {p3, p1, p2}, Lu1/a;->mutate(Lv1/e;Lv1/f$a;)Lcom/amazonaws/mobileconnectors/appsync/AppSyncMutationCall;
...
.method public mutate(Lv1/e;Z)Lcom/amazonaws/mobileconnectors/appsync/AppSyncMutationCall;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
    ...
    :cond_0
    iget-object p2, p0, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mApolloClient:Lu1/a;

    invoke-virtual {p2, p1}, Lu1/a;->mutate(Lv1/e;)Lcom/amazonaws/mobileconnectors/appsync/AppSyncMutationCall;
...
.method public query(Lv1/h;)Lcom/amazonaws/mobileconnectors/appsync/AppSyncQueryCall;
    ...
    .line 1
    iget-object v0, p0, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->mApolloClient:Lu1/a;

    .line 2
    .line 3
    invoke-virtual {v0, p1}, Lu1/a;->query(Lv1/h;)Lcom/amazonaws/mobileconnectors/appsync/AppSyncQueryCall;
...
.method public subscribe(Lv1/t;)Lcom/amazonaws/mobileconnectors/appsync/AppSyncSubscriptionCall;
    ...
    .line 4
    .line 5
    invoke-direct {v0, p1, v1}, Lcom/amazonaws/mobileconnectors/appsync/AppSyncWebSocketSubscriptionCall;-><init>(Lv1/t;Lcom/amazonaws/mobileconnectors/appsync/WebSocketConnectionManager;)V
...
.method public sync(Lv1/h;Lu1/c$a;J)LM1/a;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
    ...
    .line 1
    invoke-virtual/range {v0 .. v8}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;->sync(Lv1/h;Lu1/c$a;Lv1/t;Lcom/amazonaws/mobileconnectors/appsync/AppSyncSubscriptionCall$Callback;Lv1/h;Lu1/c$a;J)LM1/a;
...
.method public sync(Lv1/h;Lu1/c$a;Lv1/h;Lu1/c$a;J)LM1/a;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
...
.method public sync(Lv1/h;Lu1/c$a;Lv1/t;Lcom/amazonaws/mobileconnectors/appsync/AppSyncSubscriptionCall$Callback;)LM1/a;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
...
.method public sync(Lv1/h;Lu1/c$a;Lv1/t;Lcom/amazonaws/mobileconnectors/appsync/AppSyncSubscriptionCall$Callback;Lv1/h;Lu1/c$a;J)LM1/a;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D::",
    ...
    invoke-direct {v0, p1, p0, v1}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncDeltaSync;-><init>(Lv1/h;Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncClient;Landroid/content/Context;)V

    invoke-virtual {v0, p2}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncDeltaSync;->setBaseQueryCallback(Lu1/c$a;)V

    invoke-virtual {v0, p3}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncDeltaSync;->setSubscription(Lv1/t;)V
    ...
    :cond_0
    invoke-virtual {v0, p5}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncDeltaSync;->setDeltaQuery(Lv1/h;)V

    invoke-virtual {v0, p6}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncDeltaSync;->setDeltaQueryCallback(Lu1/c$a;)V
    ...
    invoke-virtual {v0, p1}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncDeltaSync;->setDeltaQuery(Lv1/h;)V

    invoke-virtual {v0, p2}, Lcom/amazonaws/mobileconnectors/appsync/AWSAppSyncDeltaSync;->setDeltaQueryCallback(Lu1/c$a;)V
