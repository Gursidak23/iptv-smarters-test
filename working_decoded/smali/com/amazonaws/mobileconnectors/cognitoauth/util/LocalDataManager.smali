...
.method public static cacheSession(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/amazonaws/mobileconnectors/cognitoauth/AuthUserSession;Ljava/util/Set;)V
    ...
    const-string v9, "CognitoIdentityProvider"
    ...
    invoke-static {v8, v11, v3}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :try_start_0
    const-string v5, "CognitoIdentityProviderCache"
...
.method public static cacheSession(Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/amazonaws/mobileconnectors/cognitoauth/AuthUserSession;Ljava/util/Set;)V
    ...
    const-string v8, "CognitoIdentityProvider"
    ...
    invoke-static {v7, v10, v2}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v13, v4}, Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;->put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4}, Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/IdToken;->getJWTToken()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0, v9, v4}, Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;->put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v4}, Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;->put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v3, v1}, Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;->put(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static clearCache(Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {p0, v6}, Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;->remove(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;->remove(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static getCachedSession(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;)Lcom/amazonaws/mobileconnectors/cognitoauth/AuthUserSession;
    ...
    new-instance v6, Lcom/amazonaws/mobileconnectors/cognitoauth/AuthUserSession;

    const/4 v7, 0x0

    invoke-direct {v6, v7, v7, v7}, Lcom/amazonaws/mobileconnectors/cognitoauth/AuthUserSession;-><init>(Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/IdToken;Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/AccessToken;Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/RefreshToken;)V
    ...
    :cond_0
    new-instance v1, Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/IdToken;
    ...
    invoke-direct {v1, v2}, Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/IdToken;-><init>(Ljava/lang/String;)V

    new-instance v2, Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/AccessToken;
    ...
    invoke-direct {v2, v3}, Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/AccessToken;-><init>(Ljava/lang/String;)V

    new-instance v3, Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/RefreshToken;
    ...
    invoke-direct {v3, v0}, Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/RefreshToken;-><init>(Ljava/lang/String;)V

    new-instance v0, Lcom/amazonaws/mobileconnectors/cognitoauth/AuthUserSession;

    invoke-direct {v0, v1, v2, v3}, Lcom/amazonaws/mobileconnectors/cognitoauth/AuthUserSession;-><init>(Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/IdToken;Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/AccessToken;Lcom/amazonaws/mobileconnectors/cognitoauth/tokens/RefreshToken;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "Failed to read from SharedPreferences"
...
.method public static getCachedSession(Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;)Lcom/amazonaws/mobileconnectors/cognitoauth/AuthUserSession;
    ...
    invoke-static {v7, v10, v5}, Ljava/lang/String;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    :try_start_0
    invoke-virtual {p0, v1}, Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lcom/amazonaws/mobileconnectors/cognitoauth/util/LocalDataManager;->setFromString(Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v9}, Lcom/amazonaws/internal/keyvaluestore/AWSKeyValueStore;->get(Ljava/lang/String;)Ljava/lang/String;
