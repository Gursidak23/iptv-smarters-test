...
.method public onResult(Lcom/amazonaws/mobile/client/results/ForgotPasswordResult;)V
    ...
    new-instance v2, Lcom/amplifyframework/auth/result/step/AuthNextResetPasswordStep;

    sget-object v3, Lcom/amplifyframework/auth/result/step/AuthResetPasswordStep;->CONFIRM_RESET_PASSWORD_WITH_CODE:Lcom/amplifyframework/auth/result/step/AuthResetPasswordStep;

    invoke-static {}, Ljava/util/Collections;->emptyMap()Ljava/util/Map;

    move-result-object v4

    iget-object v5, p0, Lcom/amplifyframework/auth/cognito/AWSCognitoAuthPlugin$12;->this$0:Lcom/amplifyframework/auth/cognito/AWSCognitoAuthPlugin;
    ...
    invoke-static {v5, p1}, Lcom/amplifyframework/auth/cognito/AWSCognitoAuthPlugin;->access$800(Lcom/amplifyframework/auth/cognito/AWSCognitoAuthPlugin;Lcom/amazonaws/mobile/client/results/UserCodeDeliveryDetails;)Lcom/amplifyframework/auth/AuthCodeDeliveryDetails;

    move-result-object p1

    invoke-direct {v2, v3, v4, p1}, Lcom/amplifyframework/auth/result/step/AuthNextResetPasswordStep;-><init>(Lcom/amplifyframework/auth/result/step/AuthResetPasswordStep;Ljava/util/Map;Lcom/amplifyframework/auth/AuthCodeDeliveryDetails;)V

    const/4 p1, 0x0

    invoke-direct {v1, p1, v2}, Lcom/amplifyframework/auth/result/AuthResetPasswordResult;-><init>(ZLcom/amplifyframework/auth/result/step/AuthNextResetPasswordStep;)V
