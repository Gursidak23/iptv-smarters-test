...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 94
    :cond_3
    invoke-static {p1}, Ld2/r;->d(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    .line 102
    :goto_1
    invoke-static {p1, p0}, Ld2/r;->g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static b(Landroid/graphics/Bitmap;LV1/b;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    .line 86
    :cond_3
    invoke-static {p0}, Ld2/r;->d(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    .line 90
    invoke-interface {p1, v3, v4, v5}, LV1/b;->d(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 100
    :cond_4
    invoke-static {p0, p1}, Ld2/r;->g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static f(Landroid/graphics/Bitmap;LV1/b;I)Landroid/graphics/Bitmap;
    .locals 4
    ...
    .line 5
    .line 6
    invoke-static {p2, v0}, Ld2/r;->e(ILandroid/graphics/Matrix;)V
    ...
    .line 55
    invoke-interface {p1, v1, v2, v3}, LV1/b;->d(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
