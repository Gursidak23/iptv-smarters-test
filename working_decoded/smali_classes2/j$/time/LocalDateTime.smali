...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v1}, Lj$/time/LocalDateTime;->K(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
...
.method public static D(Lj$/time/temporal/o;)Lj$/time/LocalDateTime;
    .locals 5
    ...
    invoke-virtual {p0}, Lj$/time/z;->H()Lj$/time/LocalDateTime;
    ...
    :cond_2
    :try_start_0
    invoke-static {p0}, Lj$/time/h;->E(Lj$/time/temporal/o;)Lj$/time/h;

    move-result-object v0

    invoke-static {p0}, Lj$/time/k;->E(Lj$/time/temporal/o;)Lj$/time/k;
...
.method public static J(I)Lj$/time/LocalDateTime;
    ...
    invoke-static {v0}, Lj$/time/k;->J(I)Lj$/time/k;
...
.method public static K(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
    .locals 1
...
.method public static L(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    .locals 5
    ...
    invoke-static {p1, p2}, Lj$/time/k;->K(J)Lj$/time/k;
...
.method private O(Lj$/time/h;JJJJ)Lj$/time/LocalDateTime;
    .locals 19
    ...
    invoke-direct {v0, v1, v6}, Lj$/time/LocalDateTime;->S(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v6}, Lj$/time/k;->S()J
    ...
    :cond_1
    invoke-static {v2, v3}, Lj$/time/k;->K(J)Lj$/time/k;
...
.method private S(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
    .locals 1
...
.method public final H(Lj$/time/LocalDateTime;)Z
    ...
    invoke-virtual {v0}, Lj$/time/k;->S()J

    move-result-wide v3

    iget-object p1, p1, Lj$/time/LocalDateTime;->b:Lj$/time/k;

    invoke-virtual {p1}, Lj$/time/k;->S()J
...
.method public final M(JLj$/time/temporal/u;)Lj$/time/LocalDateTime;
    .locals 21
    ...
    invoke-virtual {v3, v8, v9, v0}, Lj$/time/h;->Q(JLj$/time/temporal/u;)Lj$/time/h;

    move-result-object v0

    invoke-direct {v10, v0, v2}, Lj$/time/LocalDateTime;->S(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    invoke-direct {v10, v3, v2}, Lj$/time/LocalDateTime;->S(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    invoke-direct/range {v11 .. v20}, Lj$/time/LocalDateTime;->O(Lj$/time/h;JJJJ)Lj$/time/LocalDateTime;
    ...
    invoke-direct/range {v0 .. v9}, Lj$/time/LocalDateTime;->O(Lj$/time/h;JJJJ)Lj$/time/LocalDateTime;
    ...
    .line 0
    :pswitch_3
    invoke-virtual/range {p0 .. p2}, Lj$/time/LocalDateTime;->N(J)Lj$/time/LocalDateTime;
...
.method public final N(J)Lj$/time/LocalDateTime;
    .locals 10
...
.method public final Q(JLj$/time/temporal/r;)Lj$/time/LocalDateTime;
    .locals 3
    ...
    invoke-virtual {v1, p1, p2, p3}, Lj$/time/k;->U(JLj$/time/temporal/r;)Lj$/time/k;

    move-result-object p1

    invoke-direct {p0, v2, p1}, Lj$/time/LocalDateTime;->S(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    :cond_0
    invoke-virtual {v2, p1, p2, p3}, Lj$/time/h;->V(JLj$/time/temporal/r;)Lj$/time/h;

    move-result-object p1

    invoke-direct {p0, p1, v1}, Lj$/time/LocalDateTime;->S(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    :cond_1
    invoke-interface {p3, p0, p1, p2}, Lj$/time/temporal/r;->q(Lj$/time/temporal/m;J)Lj$/time/temporal/m;
...
.method public final R(Lj$/time/h;)Lj$/time/LocalDateTime;
    .locals 1

    .line 0
    iget-object v0, p0, Lj$/time/LocalDateTime;->b:Lj$/time/k;

    invoke-direct {p0, p1, v0}, Lj$/time/LocalDateTime;->S(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
...
.method final T(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v0, p1}, Lj$/time/k;->W(Ljava/io/DataOutput;)V
...
.method public final bridge synthetic d(JLj$/time/temporal/r;)Lj$/time/temporal/m;
    ...
    .line 0
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/LocalDateTime;->Q(JLj$/time/temporal/r;)Lj$/time/LocalDateTime;
...
.method public final bridge synthetic e(JLj$/time/temporal/u;)Lj$/time/temporal/m;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/LocalDateTime;->M(JLj$/time/temporal/u;)Lj$/time/LocalDateTime;
...
.method public final i(Lj$/time/temporal/r;)I
    ...
    invoke-virtual {v0, p1}, Lj$/time/k;->i(Lj$/time/temporal/r;)I
...
.method public final l(Lj$/time/temporal/r;)Lj$/time/temporal/w;
    ...
    :cond_1
    invoke-interface {p1, p0}, Lj$/time/temporal/r;->t(Lj$/time/temporal/o;)Lj$/time/temporal/w;
...
.method public final n(Lj$/time/ZoneOffset;)Lj$/time/chrono/k;
    .locals 1

    const/4 v0, 0x0

    .line 0
    invoke-static {p0, p1, v0}, Lj$/time/z;->E(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/z;
...
.method public final q(Lj$/time/temporal/r;)J
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lj$/time/k;->q(Lj$/time/temporal/r;)J
    ...
    invoke-virtual {v0, p1}, Lj$/time/h;->q(Lj$/time/temporal/r;)J
...
.method public final t(Lj$/time/temporal/t;)Ljava/lang/Object;
    .locals 1
...
.method public final u(Lj$/time/temporal/m;)Lj$/time/temporal/m;
    ...
    invoke-virtual {v1}, Lj$/time/k;->S()J
...
.method public final y(JLj$/time/temporal/u;)Lj$/time/temporal/m;
    .locals 3
    ...
    invoke-virtual {p1, v0, v1, p3}, Lj$/time/LocalDateTime;->M(JLj$/time/temporal/u;)Lj$/time/LocalDateTime;
