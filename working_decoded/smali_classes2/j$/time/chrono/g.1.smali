...
.method static E(Lj$/time/chrono/b;Lj$/time/k;)Lj$/time/chrono/g;
    .locals 1
...
.method private H(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/g;
    .locals 17
    ...
    invoke-direct {v0, v1, v6}, Lj$/time/chrono/g;->J(Lj$/time/temporal/m;Lj$/time/k;)Lj$/time/chrono/g;
...
.method private J(Lj$/time/temporal/m;Lj$/time/k;)Lj$/time/chrono/g;
    .locals 2
...
# virtual methods
.method public final D(JLj$/time/temporal/u;)Lj$/time/chrono/e;
    .locals 1
...
.method public final F(JLj$/time/temporal/u;)Lj$/time/chrono/g;
    .locals 21
    ...
    invoke-direct {v10, v0, v3}, Lj$/time/chrono/g;->J(Lj$/time/temporal/m;Lj$/time/k;)Lj$/time/chrono/g;
    ...
    invoke-direct {v10, v2, v3}, Lj$/time/chrono/g;->J(Lj$/time/temporal/m;Lj$/time/k;)Lj$/time/chrono/g;
    ...
    invoke-direct/range {v11 .. v20}, Lj$/time/chrono/g;->H(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/g;
    ...
    invoke-direct/range {v0 .. v9}, Lj$/time/chrono/g;->H(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/g;
    ...
    .line 0
    :pswitch_3
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/g;->G(J)Lj$/time/chrono/g;
...
.method final G(J)Lj$/time/chrono/g;
    .locals 10
...
.method public final I(JLj$/time/temporal/r;)Lj$/time/chrono/g;
    ...
    invoke-virtual {v2, p1, p2, p3}, Lj$/time/k;->U(JLj$/time/temporal/r;)Lj$/time/k;

    move-result-object p1

    invoke-direct {p0, v1, p1}, Lj$/time/chrono/g;->J(Lj$/time/temporal/m;Lj$/time/k;)Lj$/time/chrono/g;
    ...
    invoke-direct {p0, p1, v2}, Lj$/time/chrono/g;->J(Lj$/time/temporal/m;Lj$/time/k;)Lj$/time/chrono/g;
...
.method public final bridge synthetic e(JLj$/time/temporal/u;)Lj$/time/temporal/m;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/g;->F(JLj$/time/temporal/u;)Lj$/time/chrono/g;
...
.method public final i(Lj$/time/temporal/r;)I
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/o;->i(Lj$/time/temporal/r;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/chrono/g;->q(Lj$/time/temporal/r;)J
...
.method public final k(Lj$/time/h;)Lj$/time/temporal/m;
    ...
    invoke-direct {p0, p1, v0}, Lj$/time/chrono/g;->J(Lj$/time/temporal/m;Lj$/time/k;)Lj$/time/chrono/g;
...
.method public final l(Lj$/time/temporal/r;)Lj$/time/temporal/w;
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/o;->l(Lj$/time/temporal/r;)Lj$/time/temporal/w;
...
.method public final n(Lj$/time/ZoneOffset;)Lj$/time/chrono/k;
    ...
    .line 0
    invoke-static {p1, v0, p0}, Lj$/time/chrono/m;->E(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/k;
...
.method public final q(Lj$/time/temporal/r;)J
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/o;->q(Lj$/time/temporal/r;)J
...
.method public final synthetic t(Lj$/time/temporal/t;)Ljava/lang/Object;
    .locals 0
...
.method public final bridge synthetic y(JLj$/time/temporal/u;)Lj$/time/temporal/m;
    .locals 0

    .line 0
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/g;->D(JLj$/time/temporal/u;)Lj$/time/chrono/e;
