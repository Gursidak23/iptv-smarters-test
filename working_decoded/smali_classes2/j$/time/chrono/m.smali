...
.method static C(Lj$/time/chrono/n;Lj$/time/temporal/m;)Lj$/time/chrono/m;
    .locals 3
...
.method static E(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/k;
    .locals 6
    ...
    invoke-static {p2}, Lj$/time/LocalDateTime;->D(Lj$/time/temporal/o;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {p2, v0, v1}, Lj$/time/chrono/g;->G(J)Lj$/time/chrono/g;
...
.method static F(Lj$/time/chrono/n;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/m;
    .locals 3
    ...
    invoke-static {v1, v2, p1, v0}, Lj$/time/LocalDateTime;->L(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;

    move-result-object p1

    invoke-interface {p0, p1}, Lj$/time/chrono/n;->m(Lj$/time/LocalDateTime;)Lj$/time/chrono/e;
...
.method public final D(JLj$/time/temporal/u;)Lj$/time/chrono/k;
    ...
    invoke-static {v0, p1}, Lj$/time/chrono/m;->C(Lj$/time/chrono/n;Lj$/time/temporal/m;)Lj$/time/chrono/m;
...
.method public final G(JLj$/time/temporal/u;)Lj$/time/chrono/k;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/chrono/g;->F(JLj$/time/temporal/u;)Lj$/time/chrono/g;
    ...
    .line 0
    invoke-virtual {p1, p0}, Lj$/time/chrono/g;->u(Lj$/time/temporal/m;)Lj$/time/temporal/m;

    move-result-object p1

    .line 0
    invoke-static {p2, p1}, Lj$/time/chrono/m;->C(Lj$/time/chrono/n;Lj$/time/temporal/m;)Lj$/time/chrono/m;
...
.method public final b()Lj$/time/k;
    ...
    .line 0
    invoke-virtual {p0}, Lj$/time/chrono/m;->w()Lj$/time/chrono/e;
...
.method public final bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/chrono/m;->u(Lj$/time/chrono/k;)I
...
.method public final d(JLj$/time/temporal/r;)Lj$/time/temporal/m;
    ...
    invoke-virtual {v4, p1, p2, p3}, Lj$/time/chrono/g;->I(JLj$/time/temporal/r;)Lj$/time/chrono/g;

    move-result-object p1

    iget-object p2, p0, Lj$/time/chrono/m;->b:Lj$/time/ZoneOffset;

    invoke-static {v3, p2, p1}, Lj$/time/chrono/m;->E(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/k;
    ...
    invoke-virtual {p3}, Lj$/time/k;->H()I
    ...
    invoke-static {p2, p1, v3}, Lj$/time/chrono/m;->F(Lj$/time/chrono/n;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/m;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/m;->G(JLj$/time/temporal/u;)Lj$/time/chrono/k;
...
.method public final h(Lj$/time/ZoneId;)Lj$/time/chrono/k;
    ...
    invoke-static {p1, v1, v0}, Lj$/time/chrono/m;->E(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/g;)Lj$/time/chrono/k;
...
.method public final k(Lj$/time/h;)Lj$/time/temporal/m;
    ...
    .line 0
    invoke-virtual {p1, p0}, Lj$/time/h;->u(Lj$/time/temporal/m;)Lj$/time/temporal/m;
...
.method public final l(Lj$/time/temporal/r;)Lj$/time/temporal/w;
    ...
    invoke-virtual {v0, p1}, Lj$/time/chrono/g;->l(Lj$/time/temporal/r;)Lj$/time/temporal/w;
...
.method public final q(Lj$/time/temporal/r;)J
    ...
    invoke-virtual {v0, p1}, Lj$/time/chrono/g;->q(Lj$/time/temporal/r;)J
