...
.method private static b(BLjava/io/ObjectInput;)Ljava/io/Serializable;
    ...
    :pswitch_1
    invoke-static {p1}, Lj$/time/o;->C(Ljava/io/DataInput;)Lj$/time/o;
    ...
    :pswitch_2
    invoke-static {p1}, Lj$/time/w;->G(Ljava/io/DataInput;)Lj$/time/w;
    ...
    .line 0
    :pswitch_4
    invoke-static {p1}, Lj$/time/OffsetDateTime;->F(Ljava/io/ObjectInput;)Lj$/time/OffsetDateTime;
    ...
    :pswitch_6
    invoke-static {p1}, Lj$/time/ZoneOffset;->N(Ljava/io/DataInput;)Lj$/time/ZoneOffset;
    ...
    invoke-static {p0, p1}, Lj$/time/ZoneId;->D(Ljava/lang/String;Z)Lj$/time/ZoneId;
    ...
    .line 0
    :pswitch_8
    invoke-static {p1}, Lj$/time/z;->G(Ljava/io/ObjectInput;)Lj$/time/z;
    ...
    .line 0
    invoke-static {p1}, Lj$/time/k;->R(Ljava/io/DataInput;)Lj$/time/k;
...
.method public final writeExternal(Ljava/io/ObjectOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/o;->D(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/ZoneOffset;->O(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/x;->I(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/z;->J(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/LocalDateTime;->T(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/k;->W(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/Instant;->I(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/Duration;->t(Ljava/io/DataOutput;)V
