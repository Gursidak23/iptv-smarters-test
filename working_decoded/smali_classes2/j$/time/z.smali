...
.method private static C(JILj$/time/ZoneId;)Lj$/time/z;
    ...
    invoke-static {p0, p1, p2, v0}, Lj$/time/LocalDateTime;->L(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
...
.method public static D(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/z;
    .locals 2
...
.method public static E(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/z;
    .locals 5
    ...
    invoke-virtual {p0, v0, v1}, Lj$/time/LocalDateTime;->N(J)Lj$/time/LocalDateTime;
...
.method static G(Ljava/io/ObjectInput;)Lj$/time/z;
    .locals 3
    ...
    .line 0
    invoke-static {p0}, Lj$/time/k;->R(Ljava/io/DataInput;)Lj$/time/k;
    ...
    .line 0
    invoke-static {p0}, Lj$/time/ZoneOffset;->N(Ljava/io/DataInput;)Lj$/time/ZoneOffset;
...
.method public final F(JLj$/time/temporal/u;)Lj$/time/z;
    .locals 5
    ...
    .line 0
    invoke-virtual {v4, p1, p2, p3}, Lj$/time/LocalDateTime;->M(JLj$/time/temporal/u;)Lj$/time/LocalDateTime;

    move-result-object p1

    .line 0
    invoke-static {p1, v3, v2}, Lj$/time/z;->E(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/z;
    ...
    invoke-virtual {v3}, Lj$/time/ZoneId;->C()Lj$/time/zone/f;
    ...
    .line 0
    invoke-virtual {p1}, Lj$/time/LocalDateTime;->E()I

    move-result p1

    invoke-static {p2, p3, p1, v3}, Lj$/time/z;->C(JILj$/time/ZoneId;)Lj$/time/z;
...
.method public final I(Lj$/time/h;)Lj$/time/z;
    .locals 2
    ...
    invoke-static {p1, v0}, Lj$/time/LocalDateTime;->K(Lj$/time/h;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    invoke-static {p1, v0, v1}, Lj$/time/z;->E(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/z;
...
.method final J(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->T(Ljava/io/DataOutput;)V

    iget-object v0, p0, Lj$/time/z;->b:Lj$/time/ZoneOffset;

    invoke-virtual {v0, p1}, Lj$/time/ZoneOffset;->O(Ljava/io/DataOutput;)V

    iget-object v0, p0, Lj$/time/z;->c:Lj$/time/ZoneId;

    invoke-virtual {v0, p1}, Lj$/time/ZoneId;->G(Ljava/io/DataOutput;)V
...
.method public final c()Lj$/time/chrono/b;
    ...
    invoke-virtual {v0}, Lj$/time/LocalDateTime;->P()Lj$/time/h;
...
.method public final bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/z;->u(Lj$/time/chrono/k;)I
...
.method public final d(JLj$/time/temporal/r;)Lj$/time/temporal/m;
    ...
    invoke-virtual {v3, p1, p2, p3}, Lj$/time/LocalDateTime;->Q(JLj$/time/temporal/r;)Lj$/time/LocalDateTime;

    move-result-object p1

    .line 0
    invoke-static {p1, v4, v5}, Lj$/time/z;->E(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/z;
    ...
    invoke-virtual {v4}, Lj$/time/ZoneId;->C()Lj$/time/zone/f;
    ...
    .line 0
    :cond_2
    invoke-virtual {v3}, Lj$/time/LocalDateTime;->E()I

    move-result p3

    .line 0
    invoke-static {p1, p2, p3, v4}, Lj$/time/z;->C(JILj$/time/ZoneId;)Lj$/time/z;
...
.method public final bridge synthetic e(JLj$/time/temporal/u;)Lj$/time/temporal/m;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/z;->F(JLj$/time/temporal/u;)Lj$/time/z;
...
.method public final h(Lj$/time/ZoneId;)Lj$/time/chrono/k;
    ...
    invoke-static {v0, p1, v1}, Lj$/time/z;->E(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/z;
...
.method public final bridge synthetic k(Lj$/time/h;)Lj$/time/temporal/m;
    ...
    .line 0
    invoke-virtual {p0, p1}, Lj$/time/z;->I(Lj$/time/h;)Lj$/time/z;
...
.method public final q(Lj$/time/temporal/r;)J
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDateTime;->q(Lj$/time/temporal/r;)J
...
.method public final t(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lj$/time/LocalDateTime;->P()Lj$/time/h;
...
.method public final synthetic u(Lj$/time/chrono/k;)I
    .locals 0
...
.method public final y(JLj$/time/temporal/u;)Lj$/time/temporal/m;
    ...
    invoke-virtual {p1, v0, v1, p3}, Lj$/time/z;->F(JLj$/time/temporal/u;)Lj$/time/z;
