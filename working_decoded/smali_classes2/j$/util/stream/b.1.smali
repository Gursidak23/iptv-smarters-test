...
.method constructor <init>(Lj$/util/stream/b;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/e3;->i(II)I
...
.method private S(I)Lj$/util/Spliterator;
    ...
    invoke-virtual {v3, v4}, Lj$/util/stream/e3;->q(I)Z
    ...
    invoke-static {v4, v0}, Lj$/util/stream/e3;->i(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/e3;->i(II)I
...
# virtual methods
.method final A(Lj$/util/Spliterator;Lj$/util/stream/q2;)V
    .locals 2
    ...
    invoke-interface {p2, v0, v1}, Lj$/util/stream/q2;->m(J)V

    invoke-interface {p1, p2}, Lj$/util/Spliterator;->forEachRemaining(Ljava/util/function/Consumer;)V

    invoke-interface {p2}, Lj$/util/stream/q2;->l()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->B(Lj$/util/Spliterator;Lj$/util/stream/q2;)Z

    :goto_0
    return-void
.end method

.method final B(Lj$/util/Spliterator;Lj$/util/stream/q2;)Z
    .locals 3
    ...
    invoke-interface {p2, v1, v2}, Lj$/util/stream/q2;->m(J)V

    invoke-virtual {v0, p1, p2}, Lj$/util/stream/b;->H(Lj$/util/Spliterator;Lj$/util/stream/q2;)Z
...
.method final C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/K0;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->V(Lj$/util/Spliterator;Lj$/util/stream/q2;)Lj$/util/stream/q2;
...
.method final D(Lj$/util/stream/K3;)Ljava/lang/Object;
    .locals 1
...
.method abstract H(Lj$/util/Spliterator;Lj$/util/stream/q2;)Z
.end method

.method abstract I()Lj$/util/stream/f3;
.end method

.method final J()Lj$/util/stream/f3;
    .locals 2
    ...
    :cond_0
    invoke-virtual {v0}, Lj$/util/stream/b;->I()Lj$/util/stream/f3;
...
.method abstract R(ILj$/util/stream/q2;)Lj$/util/stream/q2;
.end method
...
.method final V(Lj$/util/Spliterator;Lj$/util/stream/q2;)Lj$/util/stream/q2;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/b;->W(Lj$/util/stream/q2;)Lj$/util/stream/q2;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lj$/util/stream/b;->A(Lj$/util/Spliterator;Lj$/util/stream/q2;)V

    return-object p2
.end method

.method final W(Lj$/util/stream/q2;)Lj$/util/stream/q2;
    .locals 3
    ...
    invoke-virtual {v0, v2, p1}, Lj$/util/stream/b;->R(ILj$/util/stream/q2;)Lj$/util/stream/q2;
