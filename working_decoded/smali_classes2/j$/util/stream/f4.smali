...
.method constructor <init>(Lj$/util/stream/b;Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)V
    ...
    invoke-virtual {p1, p2}, Lj$/util/stream/e3;->q(I)Z
...
.method protected final a()Ljava/lang/Object;
    ...
    iget-boolean v2, p0, Lj$/util/stream/f4;->j:Z

    if-eqz v2, :cond_0

    sget-object v2, Lj$/util/stream/e3;->SIZED:Lj$/util/stream/e3;

    iget-object v3, p0, Lj$/util/stream/f4;->h:Lj$/util/stream/b;

    iget v3, v3, Lj$/util/stream/b;->c:I

    invoke-virtual {v2, v3}, Lj$/util/stream/e3;->t(I)Z
    ...
    iget-object v5, p0, Lj$/util/stream/f4;->i:Ljava/util/function/IntFunction;

    invoke-virtual {v4, v2, v3, v5}, Lj$/util/stream/b;->N(JLjava/util/function/IntFunction;)Lj$/util/stream/C0;
    ...
    iget-boolean v4, p0, Lj$/util/stream/f4;->j:Z
    ...
    :goto_1
    invoke-interface {v3, v2, v1}, Lj$/util/stream/d4;->k(Lj$/util/stream/C0;Z)Lj$/util/stream/e4;
    ...
    invoke-virtual {v1, v3, v0}, Lj$/util/stream/b;->V(Lj$/util/Spliterator;Lj$/util/stream/q2;)Lj$/util/stream/q2;
    ...
    invoke-interface {v0}, Lj$/util/stream/e4;->g()J
