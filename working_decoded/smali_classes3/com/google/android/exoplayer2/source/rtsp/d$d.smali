...
# virtual methods
.method public final a(ILjava/lang/String;Ljava/util/Map;Landroid/net/Uri;)LK3/u;
    .locals 4
    ...
    .line 4
    .line 5
    invoke-static {v1}, Lcom/google/android/exoplayer2/source/rtsp/d;->V(Lcom/google/android/exoplayer2/source/rtsp/d;)Ljava/lang/String;
    ...
    .line 27
    .line 28
    invoke-static {p2}, Lcom/google/android/exoplayer2/source/rtsp/d;->c0(Lcom/google/android/exoplayer2/source/rtsp/d;)Lcom/google/android/exoplayer2/source/rtsp/h$a;
    ...
    .line 44
    .line 45
    invoke-static {v2}, Lcom/google/android/exoplayer2/source/rtsp/d;->c0(Lcom/google/android/exoplayer2/source/rtsp/d;)Lcom/google/android/exoplayer2/source/rtsp/h$a;
    ...
    .line 78
    .line 79
    invoke-direct {p2, p4, p1, p3, v0}, LK3/u;-><init>(Landroid/net/Uri;ILcom/google/android/exoplayer2/source/rtsp/e;Ljava/lang/String;)V
...
.method public b()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/rtsp/d$d;->b:LK3/u;

    invoke-static {v0}, Ld4/a;->i(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lcom/google/android/exoplayer2/source/rtsp/d$d;->b:LK3/u;

    iget-object v0, v0, LK3/u;->c:Lcom/google/android/exoplayer2/source/rtsp/e;

    invoke-virtual {v0}, Lcom/google/android/exoplayer2/source/rtsp/e;->b()Ls5/z;
    ...
    invoke-interface {v0}, Ls5/J;->keySet()Ljava/util/Set;
    ...
    :cond_1
    invoke-interface {v0, v3}, Ls5/J;->get(Ljava/lang/Object;)Ljava/util/Collection;

    move-result-object v4

    invoke-static {v4}, Ls5/D;->d(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Lcom/google/android/exoplayer2/source/rtsp/d$d;->b:LK3/u;

    iget-object v3, v3, LK3/u;->a:Landroid/net/Uri;

    invoke-virtual {p0, v0, v2, v1, v3}, Lcom/google/android/exoplayer2/source/rtsp/d$d;->a(ILjava/lang/String;Ljava/util/Map;Landroid/net/Uri;)LK3/u;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/android/exoplayer2/source/rtsp/d$d;->h(LK3/u;)V
...
.method public c(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p2, v1, p1}, Lcom/google/android/exoplayer2/source/rtsp/d$d;->a(ILjava/lang/String;Ljava/util/Map;Landroid/net/Uri;)LK3/u;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/source/rtsp/d$d;->h(LK3/u;)V
...
.method public d(I)V
    ...
    invoke-static {v2}, Lcom/google/android/exoplayer2/source/rtsp/d;->V(Lcom/google/android/exoplayer2/source/rtsp/d;)Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lcom/google/android/exoplayer2/source/rtsp/d$d;->c:Lcom/google/android/exoplayer2/source/rtsp/d;

    invoke-static {v3}, Lcom/google/android/exoplayer2/source/rtsp/d;->w(Lcom/google/android/exoplayer2/source/rtsp/d;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1}, LK3/v;-><init>(ILcom/google/android/exoplayer2/source/rtsp/e;)V

    invoke-virtual {p0, v0}, Lcom/google/android/exoplayer2/source/rtsp/d$d;->i(LK3/v;)V
...
.method public f(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-static {p1, v2}, Lcom/google/android/exoplayer2/source/rtsp/d;->t(Lcom/google/android/exoplayer2/source/rtsp/d;Z)Z
...
.method public g(Landroid/net/Uri;JLjava/lang/String;)V
    ...
    invoke-static {p2, p3}, LK3/w;->b(J)Ljava/lang/String;

    move-result-object p2

    invoke-static {v0, p2}, Ls5/A;->m(Ljava/lang/Object;Ljava/lang/Object;)Ls5/A;

    move-result-object p2

    const/4 p3, 0x6

    invoke-virtual {p0, p3, p4, p2, p1}, Lcom/google/android/exoplayer2/source/rtsp/d$d;->a(ILjava/lang/String;Ljava/util/Map;Landroid/net/Uri;)LK3/u;
...
.method public final h(LK3/u;)V
    .locals 2

    .line 1
    iget-object v0, p1, LK3/u;->c:Lcom/google/android/exoplayer2/source/rtsp/e;
    ...
    .line 45
    .line 46
    invoke-static {p1}, Lcom/google/android/exoplayer2/source/rtsp/h;->q(LK3/u;)Ls5/y;
    ...
    .line 61
    invoke-virtual {v1, v0}, Lcom/google/android/exoplayer2/source/rtsp/g;->h(Ljava/util/List;)V

    .line 62
    .line 63
    .line 64
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/rtsp/d$d;->b:LK3/u;
...
.method public final i(LK3/v;)V
    .locals 1

    .line 1
    invoke-static {p1}, Lcom/google/android/exoplayer2/source/rtsp/h;->r(LK3/v;)Ls5/y;
    ...
    .line 16
    invoke-virtual {v0, p1}, Lcom/google/android/exoplayer2/source/rtsp/g;->h(Ljava/util/List;)V
...
.method public j(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p3, p2, p1}, Lcom/google/android/exoplayer2/source/rtsp/d$d;->a(ILjava/lang/String;Ljava/util/Map;Landroid/net/Uri;)LK3/u;
