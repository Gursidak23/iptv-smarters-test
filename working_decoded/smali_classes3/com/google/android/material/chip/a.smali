...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Ll5/g;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p0, p1}, Ll5/g;->L(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/google/android/material/chip/a;->l0:Landroid/content/Context;

    new-instance p2, Lf5/s;

    invoke-direct {p2, p0}, Lf5/s;-><init>(Lf5/s$b;)V

    iput-object p2, p0, Lcom/google/android/material/chip/a;->s0:Lf5/s;

    const-string v0, ""

    iput-object v0, p0, Lcom/google/android/material/chip/a;->H:Ljava/lang/CharSequence;

    invoke-virtual {p2}, Lf5/s;->e()Landroid/text/TextPaint;
...
.method public static q1(Li5/d;)Z
    .locals 1
    ...
    .line 2
    .line 3
    invoke-virtual {p0}, Li5/d;->i()Landroid/content/res/ColorStateList;
...
.method public final A0(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-static {v1, v2}, LG/a;->o(II)I
...
.method public A2(Ljava/lang/CharSequence;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/chip/a;->s0:Lf5/s;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Lf5/s;->i(Z)V
...
.method public final B0(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object p2, p0, Lcom/google/android/material/chip/a;->s0:Lf5/s;

    invoke-virtual {p2}, Lf5/s;->d()Li5/d;
    ...
    invoke-virtual {p2, v1}, Lf5/s;->j(Landroid/content/Context;)V
    ...
    invoke-virtual {p2, v0}, Lf5/s;->f(Ljava/lang/String;)F
    ...
    iget-object v2, p0, Lcom/google/android/material/chip/a;->s0:Lf5/s;
    ...
    iget-object v0, p0, Lcom/google/android/material/chip/a;->s0:Lf5/s;
...
.method public B2(Li5/d;)V
    ...
    .line 4
    .line 5
    invoke-virtual {v0, p1, v1}, Lf5/s;->h(Li5/d;Landroid/content/Context;)V
...
.method public C2(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/chip/a;->B2(Li5/d;)V
...
.method public final N2()V
    ...
    invoke-static {v0}, Lj5/b;->d(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public final W0()F
    ...
    invoke-static {v1, v2}, Lf5/w;->b(Landroid/content/Context;I)F
...
.method public W1(F)V
    ...
    invoke-super {p0, p1}, Ll5/g;->d0(F)V
...
.method public Z0()LS4/f;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/google/android/material/chip/a;->Y:LS4/f;
...
.method public a2(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, LN/a;->h(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method public d1()LS4/f;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/google/android/material/chip/a;->X:LS4/f;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static/range {v2 .. v7}, LW4/a;->a(Landroid/graphics/Canvas;FFFFI)I
    ...
    invoke-super {p0, p1}, Ll5/g;->draw(Landroid/graphics/Canvas;)V
...
.method public getIntrinsicWidth()I
    ...
    iget-object v1, p0, Lcom/google/android/material/chip/a;->s0:Lf5/s;
    ...
    invoke-virtual {v1, v2}, Lf5/s;->f(Ljava/lang/String;)F
...
.method public getOutline(Landroid/graphics/Outline;)V
    ...
    invoke-super {p0, p1}, Ll5/g;->getOutline(Landroid/graphics/Outline;)V
...
.method public isStateful()Z
    ...
    invoke-static {v0}, Lcom/google/android/material/chip/a;->q1(Li5/d;)Z
...
.method public o2(LS4/f;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/google/android/material/chip/a;->Y:LS4/f;
...
.method public onStateChange([I)Z
    ...
    invoke-super {p0, p1}, Ll5/g;->onStateChange([I)Z
...
.method public p2(I)V
    ...
    invoke-static {v0, p1}, LS4/f;->c(Landroid/content/Context;I)LS4/f;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/chip/a;->o2(LS4/f;)V
...
.method public final r1(Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p3, p2, v0}, Li5/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p3, p2, v1}, Li5/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p3, p2, v1}, Li5/c;->f(Landroid/content/Context;Landroid/content/res/TypedArray;I)Li5/d;

    move-result-object p3

    sget v1, LR4/l;->t0:I

    invoke-virtual {p3}, Li5/d;->j()F
    ...
    invoke-virtual {p3, v1}, Li5/d;->l(F)V
    ...
    invoke-static {v1, p2, v2}, Li5/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-virtual {p3, v1}, Li5/d;->k(Landroid/content/res/ColorStateList;)V

    :cond_1
    invoke-virtual {p0, p3}, Lcom/google/android/material/chip/a;->B2(Li5/d;)V
    ...
    invoke-static {v1, p2, v2}, Li5/c;->d(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2, p3}, Li5/c;->d(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2, p3}, LS4/f;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)LS4/f;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/chip/a;->y2(LS4/f;)V
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, v0, p1}, Lb5/a;->b(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final t1([I[I)Z
    ...
    :goto_0
    invoke-virtual {p0, v1}, Ll5/g;->l(I)I
    ...
    :goto_1
    invoke-virtual {p0, v3}, Ll5/g;->l(I)I
    ...
    :cond_3
    invoke-static {v1, v3}, LZ4/a;->g(II)I
    ...
    :goto_2
    invoke-virtual {p0}, Ll5/g;->x()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v0}, Ll5/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v1}, Lf5/s;->d()Li5/d;
    ...
    invoke-virtual {v1}, Li5/d;->i()Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0, v3}, Lb5/a;->b(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public y2(LS4/f;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/google/android/material/chip/a;->X:LS4/f;
...
.method public final z0(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v0, p2}, Ll5/g;->h(Landroid/graphics/RectF;Landroid/graphics/Path;)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Ll5/g;->p(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/Path;Landroid/graphics/RectF;)V
