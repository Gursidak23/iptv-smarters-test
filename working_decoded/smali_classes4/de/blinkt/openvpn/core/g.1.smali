...
# direct methods
.method public static a(Landroid/content/Context;Ljava/lang/String;)Lde/blinkt/openvpn/core/g$b;
    .locals 5

    .line 1
    invoke-static {p0}, Lde/blinkt/openvpn/core/g;->b(Landroid/content/Context;)V
    ...
    new-instance v2, Lde/blinkt/openvpn/core/g$a;

    invoke-direct {v2, v0}, Lde/blinkt/openvpn/core/g$a;-><init>(Ljava/util/concurrent/BlockingQueue;)V
    ...
    new-instance p1, Lde/blinkt/openvpn/core/g$b;
    ...
    invoke-direct {p1, p0, v2, v0}, Lde/blinkt/openvpn/core/g$b;-><init>(Landroid/content/Context;Landroid/content/ServiceConnection;Lh8/c;)V
...
.method public static c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)[Ljava/security/cert/X509Certificate;
    ...
    invoke-static {p0, p1}, Lde/blinkt/openvpn/core/g;->a(Landroid/content/Context;Ljava/lang/String;)Lde/blinkt/openvpn/core/g$b;
    ...
    :try_start_1
    invoke-virtual {p0}, Lde/blinkt/openvpn/core/g$b;->a()Lh8/c;

    move-result-object p1

    invoke-interface {p1, p2}, Lh8/c;->getCertificateChain(Ljava/lang/String;)[B
    ...
    :try_start_2
    invoke-virtual {p0}, Lde/blinkt/openvpn/core/g$b;->close()V
    :try_end_2
    ...
    :cond_0
    :try_start_3
    invoke-static {p1}, Lde/blinkt/openvpn/core/g;->e([B)Ljava/util/Collection;
...
.method public static d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[BLandroid/os/Bundle;)[B
    ...
    invoke-interface {p1, p2, p3, p4}, Lh8/c;->I0(Ljava/lang/String;[BLandroid/os/Bundle;)[B

    move-result-object p4

    if-nez p4, :cond_0

    invoke-interface {p1, p2, p3}, Lh8/c;->x(Ljava/lang/String;[B)[B
