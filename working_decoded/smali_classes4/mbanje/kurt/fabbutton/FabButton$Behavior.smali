...
.method public final F(Lmbanje/kurt/fabbutton/FabButton;)V
    ...
    invoke-virtual {p1, v0}, LP/S;->f(F)LP/S;

    move-result-object p1

    invoke-virtual {p1, v0}, LP/S;->g(F)LP/S;
    ...
    sget-object v0, LM8/a;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {p1, v0}, LP/S;->i(Landroid/view/animation/Interpolator;)LP/S;

    move-result-object p1

    invoke-virtual {p1}, LP/S;->p()LP/S;
...
.method public final H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lmbanje/kurt/fabbutton/FabButton;)F
    ...
    invoke-static {v4}, LP/L;->N(Landroid/view/View;)F
...
.method public final I(Lcom/google/android/material/appbar/AppBarLayout;)I
    ...
    .line 1
    invoke-static {p1}, LP/L;->F(Landroid/view/View;)I
...
.method public K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lmbanje/kurt/fabbutton/FabButton;Landroid/view/View;)Z
    ...
    invoke-static {p1, p3, v1}, LM8/f;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public final L(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lmbanje/kurt/fabbutton/FabButton;Landroid/view/View;)V
    ...
    invoke-static {p2}, LP/L;->e(Landroid/view/View;)LP/S;
    ...
    invoke-virtual {p2, p1}, LP/S;->o(F)LP/S;

    move-result-object p2

    sget-object p3, LM8/a;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {p2, p3}, LP/S;->i(Landroid/view/animation/Interpolator;)LP/S;
    ...
    :cond_0
    invoke-static {p2, p1}, LP/L;->M0(Landroid/view/View;F)V
