...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, LB8/h;->m(II)LB8/c;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, LB8/h;->l(LB8/a;I)LB8/a;

    move-result-object p2

    invoke-virtual {p2}, LB8/a;->d()I

    move-result v1

    invoke-virtual {p2}, LB8/a;->f()I

    move-result v2

    invoke-virtual {p2}, LB8/a;->g()I
